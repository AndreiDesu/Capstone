...
class _PackagesPageState extends State<PackagesPage> {
  ...
  void _showPackageForm([Map<String, dynamic>? pkg]) {
    ...
    final hoursController = TextEditingController(text: pkg?['hours'] ?? '');
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                _formField("Day Type", typeController),
                _formField("Week Schedule", scheduleController),
                _formField("Hours", hoursController),
